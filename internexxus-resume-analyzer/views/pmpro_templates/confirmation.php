...
?>
<div class="custom_content_membership_pro">
<p>Please wait... You will be redirected to the resume analyzer page in <span id="countdown">10</span> seconds.</p>
...
<script>
	var redirectPage = '<?php echo home_url('/upload-resume/'); ?>'
